...
__all__ = ['WideResNet', 'wrn_16_1', 'wrn_16_2', 'wrn_40_1', 'wrn_40_2', 'wrn_34_10']
...
def wrn_34_10(num_classes, dropout_rate=0):
    return WideResNet(depth=34, num_classes=num_classes, widen_factor=10, dropout_rate=dropout_rate)
